...
node_categories = [
    ...
    NoodleNodeCategory("IO", "I/O", items=[
        NodeItem(PRE+"KeyInputNode"),
    ]),
    NoodleNodeCategory("MOVE", "Movement", items=[
        NodeItem(PRE+"MoveCharacterNode"),
    ]),
    NoodleNodeCategory("LOGIC", "Logic", items=[
        NodeItem(PRE+"FlowOrNode"),
    ]),
